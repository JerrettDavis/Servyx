...
/// directly, and <see cref="LocalProcessBackupProvider.PruneAsync"/>'s dry-run and live paths compute their
...
/// the three barriers described on <see cref="LocalProcessBackupProvider.PruneAsync"/>.
/// </para>
/// <para>
/// This duplicates the Docker and SSH copies — see the remarks on <see cref="BackupGlob"/> for why, and note
/// that this type, being pure policy over <see cref="BackupArtifact"/>, is the strongest candidate of the
/// four for promotion to <c>Servyx.Domain.Backups</c> when that refactor is done on its own.
/// </para>
/// </remarks>
